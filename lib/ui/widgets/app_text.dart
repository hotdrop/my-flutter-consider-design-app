...
class AppText extends StatelessWidget {
  ...
  factory AppText.normal(String text, {Color? color, TextStyle? style}) {
    return AppText._(text, color, 16);
  }

  factory AppText.large(String text, {Color? color, TextStyle? style}) {
    return AppText._(text, color, 24);
  }

  factory AppText.huge(String text, {Color? color, TextStyle? style}) {
