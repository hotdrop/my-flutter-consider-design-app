class CommonStrings {
  ...
  final String pointGetInputTextFieldLabel = 'ポイントを入力';
  ...
  final String pointUseInputTextFieldLabel = '利用ポイント入力';
  ...
  final String pointUseConfirmDetail = 'よろしければ「ポイントを使用する」ボタンをタップしてください。';
